import numpy as np  
import sys,os  
caffe_root = '/home/zr/caffe/'
sys.path.insert(0, caffe_root + 'python')  
import caffe  

train_proto = 'trainfine.prototxt'  
train_model = 'Trainfine_AstroDetect_300x300_iter_100000.caffemodel'  #should be your snapshot caffemodel

deploy_proto = 'deployBN.prototxt'  
save_model = 'MobileNetAstro_deploy.caffemodel'
